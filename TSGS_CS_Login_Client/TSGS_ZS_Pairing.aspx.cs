...
namespace TSGS_CS_Login_Client
{
    ...
    public partial class TSGS_ZS_Pairing : System.Web.UI.Page
    {
        ...
        protected void Fill_Texts()
        {
            ...
            Button1.Text = Client_MLC.GetMLCText((string)Session["Project"], "NewPairing", (int)Session["Language"], 3).Trim();
            Button2.Text = Client_MLC.GetMLCText((string)Session["Project"], "NewPairing", (int)Session["Language"], 5).Trim();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Client_WCF.Calculate_New_Pairing_Swiss((int)Session["Competition_Identification"], (int)Session["Round_Number"], (int)Session["GamesPerRound"]);
            Updatepanel1.Visible = false;
            Button2.Visible = true;
            Session["Current_Status"] = 34;
