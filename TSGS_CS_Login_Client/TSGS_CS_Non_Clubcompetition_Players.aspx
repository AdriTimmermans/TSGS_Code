            ...
            <td>
                <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="false" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDataBound="GridView1_RowDataBound">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="cbKroongroep">
                            <EditItemTemplate></EditItemTemplate>
                            <ItemTemplate>
                                <asp:CheckBox ID="cbKroongroep" runat="server" AutoPostBack="true" OnCheckedChanged="OnKroongroepChanged" Text=" " />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="DDLKroongroep">
                            <EditItemTemplate></EditItemTemplate>
                            <ItemTemplate>
                                <asp:DropDownList ID="DDLCGGames" runat="server" AutoPostBack="true" Visible="false" OnSelectedIndexChanged="OnGameSelected" Width="250px"></asp:DropDownList>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="DDLKroongroepLists" Visible="false">
                            <EditItemTemplate></EditItemTemplate>
                            <ItemTemplate>
                                <asp:ListBox ID="lbox_Gamenr" runat="server" ></asp:ListBox>
                                <asp:ListBox ID="lbox_Color" runat="server"></asp:ListBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="PartijnrKroongroep">
                            <EditItemTemplate></EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lbl_CG_Adversary_Name" runat="server" BackColor="Transparent"></asp:Label>
                                <asp:TextBox ID="InputKroongroep" runat="server" AutoPostBack="true" Visible="false" Width="50px"   Text="0" />
                                <asp:TextBox ID="tb_Adversary_Id" runat="server" AutoPostBack="true" Visible="false" Width="50px"   Text="" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
