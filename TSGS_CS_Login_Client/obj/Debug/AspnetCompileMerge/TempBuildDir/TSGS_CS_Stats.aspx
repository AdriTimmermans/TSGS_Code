<%@ Page Title="" Language="C#" MasterPageFile="~/TSGS_CS_Master.Master" AutoEventWireup="true" CodeBehind="TSGS_CS_Stats.aspx.cs" Inherits="TSGS_CS_Login_Client.TSGS_CS_Stats" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="false" OnPageIndexChanging="GridView1_PageIndexChanging">
        ...
        <Columns>
            <asp:TemplateField HeaderText="Ronde" ItemStyle-HorizontalAlign="Right">
                <ItemTemplate>
                    <%#Eval("Ronde")%>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Intern" ItemStyle-HorizontalAlign="Right">
                <ItemTemplate>
                    <%#Eval("Intern")%>
                </ItemTemplate>
                <EditItemTemplate></EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Extern" ItemStyle-HorizontalAlign="Right">
                <ItemTemplate>
                    <%#Eval("Extern")%>
                </ItemTemplate>
                <EditItemTemplate></EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Vrij" ItemStyle-HorizontalAlign="Right">
                <ItemTemplate>
                    <%#Eval("Vrij")%>
                </ItemTemplate>
                <EditItemTemplate></EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Afwezig" ItemStyle-HorizontalAlign="Right">
                <ItemTemplate>
                    <%#Eval("Afwezig")%>
                </ItemTemplate>
                <EditItemTemplate></EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Totaal" ItemStyle-HorizontalAlign="Right">
                <ItemTemplate>
                    <%#Eval("Totaal")%>
                </ItemTemplate>
                <EditItemTemplate></EditItemTemplate>
