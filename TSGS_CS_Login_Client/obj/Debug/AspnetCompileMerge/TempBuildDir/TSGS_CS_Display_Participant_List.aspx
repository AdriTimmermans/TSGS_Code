                ...
                <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="false" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDataBound="GridView1_RowDataBound">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Team">
                            <EditItemTemplate></EditItemTemplate>
                            <ItemTemplate>
                                <asp:TextBox ID="tbTeam" runat="server" AutoPostBack="false" Width="10" autocomplete="off" Text='<%#Eval("Team")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Kroongroep">
                            <EditItemTemplate></EditItemTemplate>
                            <ItemTemplate>
                                <asp:CheckBox ID="cbKroongroep" runat="server" AutoPostBack="false" Text=" " />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Spelendlid">
                            <EditItemTemplate></EditItemTemplate>
                            <ItemTemplate>
                                <asp:CheckBox ID="cbSpelend" runat="server" AutoPostBack="false" Text=" " />
                            </ItemTemplate>
                        </asp:TemplateField>                        
