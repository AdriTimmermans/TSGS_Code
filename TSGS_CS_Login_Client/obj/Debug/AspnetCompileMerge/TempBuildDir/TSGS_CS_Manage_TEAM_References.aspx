    ...
    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="false" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDataBound="GridView1_RowDataBound" ShowFooter="True" OnRowCommand="GridView1_RowCommand">
        ...
        <Columns>
            <asp:TemplateField ControlStyle-Width="50">
                <ItemTemplate>
                    <asp:LinkButton ID="lbEdit" runat="server" CommandName="EditRow" CommandArgument='<%#Eval("Team_Record_Nummer")%>'><img src="images/edit.png" width="25"></asp:LinkButton>
                    <asp:LinkButton ID="lbDelete" runat="server" CommandName="DeleteRow" CommandArgument='<%#Eval("Team_Record_Nummer")%>'><img src="images/delete.png" width="25"></asp:LinkButton>
                </ItemTemplate>
                <EditItemTemplate>
                    <asp:LinkButton ID="lbUpdate" runat="server" CommandName="UpdateRow" CommandArgument='<%#Eval("Team_Record_Nummer")%>'><img src="images/update.png" width="25"></asp:LinkButton>
                    <asp:LinkButton ID="lbCancel" runat="server" CommandName="CancelUpdate" CommandArgument='<%#Eval("Team_Record_Nummer")%>'><img src="images/Delete-icon.png" width="25"></asp:LinkButton>
                </EditItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Vereniging">
                ...
                <FooterTemplate>
                    <asp:LinkButton ID="lbInsert" runat="server" CommandName="InsertRow"><img src="images/folder-full-add-icon.png" width="30"></asp:LinkButton>
                </FooterTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Team_Nr">
                ...
                <FooterTemplate>
                    <div style="float: right">
                    <asp:TextBox ID="TextBox16" Width="25" runat="server" Text=""></asp:TextBox>
                    </div>
                </FooterTemplate>
            </asp:TemplateField>
