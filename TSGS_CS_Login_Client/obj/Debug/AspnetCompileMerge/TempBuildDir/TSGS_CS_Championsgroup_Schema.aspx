    ...
    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="false">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Lotingnummer">
                <EditItemTemplate></EditItemTemplate>
                <ItemTemplate>
                    <asp:TextBox ID="tbLotingnummer" runat="server" AutoPostBack="true" onkeydown="return (event.keyCode!=13);" Width="25" autocomplete="off" OnTextChanged="tbLotingnummer_TextChanged" Text='<%#Eval("Lotnumber")%>' />
                </ItemTemplate>
            </asp:TemplateField>
