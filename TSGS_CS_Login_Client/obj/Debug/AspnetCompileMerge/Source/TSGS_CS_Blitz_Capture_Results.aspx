                ...
                <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="false" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDataBound="GridView1_RowDataBound">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Groepnr">
                            <EditItemTemplate></EditItemTemplate>
                            <ItemTemplate>
                                <asp:TextBox ID="Groepnr" runat="server" width="40" OnTextChanged="OnInputGroepChanged" onkeydown = "return (event.keyCode!=13);" autocomplete="off" Text='<%#Eval("Groepnr")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="MatchPunten">
                            <EditItemTemplate></EditItemTemplate>
                            <ItemTemplate>
                                <asp:TextBox ID="MatchPunten" width="40" runat="server" OnTextChanged="OnInputMatchpuntenChanged" onkeydown = "return (event.keyCode!=13);" autocomplete="off" Text='<%#Eval("Matchpunten")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
