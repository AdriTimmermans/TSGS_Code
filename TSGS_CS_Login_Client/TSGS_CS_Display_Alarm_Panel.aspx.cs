...
namespace TSGS_CS_Login_Client
{
    ...
    public partial class TSGS_CS_Display_Alarm_Panel : System.Web.UI.Page
    {

        protected void Page_Load(object sender, EventArgs e)
        {
            Session["Functionality"] = "DisplayAlarm";
        ...
        protected void Fill_Texts()
        {
            ...
            */
            ...
            DataSet ds = Client_WCF.GetAlarmPanelData((string)Session["Manager"]);
            Client_WCF.Close();
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                tbRecordnr.Text = Convert.ToString(dr["Recordnr"]);
                tbRecordnr.ReadOnly = true;
                CheckBox cbHandled = (CheckBox)e.Row.FindControl("cbHandled");
                int DebugLevelValue = Convert.ToInt16(dr["DebugLevelValue"]);
                cbHandled.Visible = (DebugLevelValue == 1);
...
*/
        ...
        protected void OnHandledChanged(object sender, EventArgs e)
        {
            ...
            Client_WCF.UpdateAlarmPanelIndicator(System.Convert.ToInt16(cbHandled.Checked), System.Convert.ToInt32(tbRecord.Text));
            Client_MLC.Close();
            Client_WCF.Close();
        }
