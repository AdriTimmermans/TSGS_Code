...
namespace TSGS_CS_WCF_Service
{
    public class PlayerBasicData
    {
	    ...
	    private float _StartSnelschaakRating;
	    private float _Snelschaakrating; 
	    private float _StartCompetitiepunten;
	    private float _Competitiepunten; 
	    private sbyte _Team;
	    ...
	    private float _StartRapidrating; 
        ...
        public float StartSnelschaakRating { get { return _StartSnelschaakRating; } set { _StartSnelschaakRating = value; } }
        public float Snelschaakrating { get { return _Snelschaakrating; } set { _Snelschaakrating = value; } }
        public float StartCompetitiepunten { get { return _StartCompetitiepunten; } set { _StartCompetitiepunten = value; } }
        public float Competitiepunten { get { return _Competitiepunten; } set { _Competitiepunten = value; } }
        ...
        public float StartRapidrating { get { return _StartRapidrating; } set { _StartRapidrating = value; } }
