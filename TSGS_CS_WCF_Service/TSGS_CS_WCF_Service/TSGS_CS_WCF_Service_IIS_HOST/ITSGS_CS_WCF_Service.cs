...
namespace TSGS_CS_WCF_Service
{
    ...
    public interface ITSGS_CS_WCF_Service
    {
        ...
        [OperationContract]
        void FTP_Basis_Upload_File(string Display_Target, string App_Source, int CID, string File_Name);
        ...
        [OperationContract]
        bool AddPlayerCompetitionRecord(int CID, int PID, float CPS, float ELO);
        ...
        [OperationContract]
        void WriteLogLine(string User, int CID, string Module, string Level, string LogLine);
        ...
        [OperationContractAttribute]
        bool HandleOneMutationRecord(int OIL, int VIL);

        [OperationContractAttribute]
        bool CleanUpMutationRecords();
